<template>
  <div class="slider" ref="slider">
    ...
    >
      <div class="slider-item" v-if="loop" :style="itemHeight" v-html="lastItem"></div>
      <slot></slot>
      <div class="slider-item" v-if="loop" :style="itemHeight" v-html="firstItem"></div>
    </div>
...
export default {
  ...
  methods: {
    init () {
      ...
      this.itemsArr = this.$children.filter(item => item.$options.name === 'slider-item');
...
.slider {
  ...
  .slider-wrapper {
    ...
    slider-wrapper-vertical-vertical {
  ...
  .slider-pagination {
    ...
    opacity: 0;
    animation: yd-kf-opacity-in 0.3s linear 0.4s forwards;
